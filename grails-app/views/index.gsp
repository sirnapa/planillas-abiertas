...
<html>
	<head>
		...
		<title>Bienvenido a Planillas abiertas</title>
		    ...
		    <div class="container">
		      <div class="row">
		        <div class="one-half column">
		          ...
		          <g:link controller="planilla" class="button button-primary">Planillas</g:link>
		        </div>
		        <div class="one-half column phones">
		          <img class="phone" src="${assetPath(src: 'iphone.png')}">
		        </div>
		      </div>
		    </div>
		  </div>
		    ...
		    <div class="container">
		      ...
		      <div class="row">
		        <div class="one-half column category">
		          <img class="u-max-full-width" src="${assetPath(src: 'placeholder.png')}">
		        </div>
		        <div class="one-half column category">
   		          <img class="u-max-full-width" src="${assetPath(src: 'placeholder.png')}">
		        </div>
